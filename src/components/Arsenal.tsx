...
export default function Arsenal() {
  return (
    <section className="grid grid-cols-1 lg:grid-cols-2 gap-16 pt-20">
      {/* Lab Notes */}
      <div className="brutalist-card bg-white p-12 rotate-[-1deg] relative">
        <div className="tape-accent -top-6 -right-6 rotate-12 bg-electric-cyan/80 w-48"></div>
        <h3 className="font-sans text-4xl font-black mb-12 border-b-8 border-ink inline-block pb-2 tracking-tighter">
      ...
      {/* Tech Arsenal */}
      <div className="brutalist-card bg-ink text-white p-12 rotate-[1deg] relative">
        <div className="absolute -top-8 -left-8 bg-white text-ink border-4 border-ink p-3 rotate-[-5deg] font-mono text-xs font-bold uppercase tracking-widest z-20 shadow-[6px_6px_0px_0px_#F7D046]">
          LOADED_MODULES.EXE
        </div>
        <h3 className="font-sans text-4xl font-black mb-12 border-b-8 border-cyber-yellow inline-block pb-2 tracking-tighter text-white">
          TECH ARSENAL
        </h3>
            ...
            <div key={i}>
              ...
              <div className="flex flex-wrap gap-4">
                {category.skills.map((skill, j) => (
                  <span
                    key={j}
                    className="bg-white text-ink border-2 border-ink px-4 py-1.5 font-mono text-sm font-bold shadow-[4px_4px_0px_0px_#EB5E93]"
                  >
                    {skill}
                  </span>
                ))}
